...
sudo sed -i "s|^Icon=.*|Icon=$icon_path|" /usr/share/applications/org.kde.dolphin.desktop

qss_path=$(realpath dolphin/dolphin.qss)
sudo sed -i "s|^Exec=.*|Exec=dolphin %u -stylesheet $qss_path|" /usr/share/applications/org.kde.dolphin.desktop
